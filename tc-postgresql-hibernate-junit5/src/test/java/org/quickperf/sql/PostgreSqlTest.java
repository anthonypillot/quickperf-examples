...
public class PostgreSqlTest {
    ...
    protected void insertPlayers(int playerNumber, List<Long> idsTeamList, int batchSize) throws SQLException {
    ...
    protected List<Long> insertTeams(int teamNumber, int batchSize) throws SQLException {
